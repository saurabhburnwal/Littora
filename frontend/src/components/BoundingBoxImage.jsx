  ...
  return (
    <div className="bbox-interactive-wrapper">
      <div className={`modal-img-container${lightbox ? " modal-img-container--lightbox" : ""}`}>
        <div className="modal-image-frame" style={aspectRatio ? { aspectRatio } : undefined}>
          <img
            src={src}
            alt={alt}
      ...
      {/* Interactive Toolbar — category toggle chips & optional confidence slider */}
      {validBoxes.length > 0 && !lightbox && (
